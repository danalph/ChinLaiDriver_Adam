...
class ProductListAdapter(var list: MutableList<ProductListResponse.Data.Product>, var onItemClickListener: OnItemClickListener): RecyclerView.Adapter<ProductListAdapter.ProductListViewHolder>(), Filterable{
